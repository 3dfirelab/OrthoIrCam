...
params_rawData = {'root':           '/media/paugam/BegArScarf/ClosingGap/data/',
                  'root_data':      '/media/paugam/BegArScarf/ClosingGap/data/2022_Eugene/whale_pasture_main/',
                  #'root_postproc' : '/home/paugam/2008_Ngarkat/Postproc/',
                  'root_postproc' : '/media/paugam/BegArScarf/ClosingGap/Postproc/2022_Eugene/whale_pasture_main/',
                  'plotname': '22EuWPM',
                  'fire_date'      : '1970-01-01',
                  
                  #lwir
                  'root_data_DirLwir': '/XT2/MAT/',
                  'startTime_lwir' :  0,
                  'endTime_lwir'   :  264,
...
params_gps = {  'dir_gps'      : 'Instruments_Location/',
                ...
                'loc_cf_file'  : 'euwpm_gcps.kml',
                'cf_feature_name'   : 'euwpm_gcps', 
